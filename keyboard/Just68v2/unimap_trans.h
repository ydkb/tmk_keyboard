...
const uint8_t PROGMEM unimap_trans[5][16] = {
    { UM_ESC, UM_2,   UM_1,   UM_3,   UM_4,   UM_5,   UM_6,   UM_7,        UM_8,   UM_9,   UM_0,   UM_MINS,UM_EQL, UM_BSPC,UM_HOME,UM_F13, },
    { UM_TAB, UM_Q,   UM_W,   UM_E,   UM_R,   UM_T,   UM_Y,   UM_U,        UM_I,   UM_O,   UM_P,   UM_LBRC,UM_RBRC,UM_BSLS,UM_PGUP,UM_F14, },
    ...
    { UM_NO,  UM_NO,  UM_NO,  UM_NO,  UM_NO,  UM_NO,   UM_NO, UM_NO,       UM_SPC, UM_NO,  UM_RALT,UM_RCTL,UM_RGUI,UM_LEFT,UM_DOWN,UM_RGHT,}
};
