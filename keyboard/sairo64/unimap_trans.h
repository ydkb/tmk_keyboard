...
const uint8_t PROGMEM unimap_trans[MATRIX_ROWS][MATRIX_COLS] = {
    ...
    { UM_CAPS,UM_A,   UM_S,   UM_D,   UM_F,   UM_G,   UM_H,   UM_J,   UM_K,   UM_L,   UM_SCLN,UM_QUOT,UM_ENT, UM_NO   },
    { UM_LSFT,UM_Z,   UM_X,   UM_C,   UM_V,   UM_B,   UM_N,   UM_M,   UM_COMM,UM_DOT, UM_SLSH,UM_RSFT,UM_UP,  UM_DEL  },
    { UM_LCTL,UM_LGUI,UM_LALT,UM_NO,  UM_NO,  UM_SPC, UM_NO,  UM_NO,  UM_NO,  UM_RALT,UM_RCTL,UM_LEFT,UM_DOWN,UM_RGHT }
};
