...
#define PRODUCT_ID      0x1964
#define DEVICE_VER      0x0001
#define MANUFACTURER    YANG
#define PRODUCT         Sairo64 Keyboard
#define DESCRIPTION     t.m.k. keyboard firmware for Sairo64
...
#define bt_power_init()    do { DDRD |= (1<<PD4); PORTD &= ~(1<<PD4); DDRF &= ~(1<<PF6); PORTF |= (1<<PF6);} while(0)
